...
var h1 = {
	...
	"font-size": function fontSize() {
		return plato.scale(window.innerWidth, plato.layout.wrappers.mobile, 3600, 72, 120) * 1.5;
	}
};
var h2 = Descartes.extend(h1, {
	...
	"margin": 0,
	"font-size": function fontSize() {
		return plato.scale(window.innerWidth, plato.layout.wrappers.mobile, 3600, 24, 36) * 1.5;
	}
});
var strong = {
	"font-weight": 600
